...
<div id="wraper">
    ...
    <div id="mypage_password_list">
        <div id="mypage_password_text">회원님의 소중한 정보 보호를 위해 현재<br>비밀번호를 변경해주세요</div>
        <form action="../php/change_password.php" method="post">
            <input type="password" name="current_pwd" id="mypage_password_check" placeholder="비밀번호">
            <input type="password" name="new_pwd" id="mypage_password_check" placeholder="새로운 비밀번호">
            <input type="password" name="pwd_check" id="mypage_password_check" placeholder="비밀번호 확인"><br>
            <div id="mypage_password_message">-안전을 위해 자주 사용했거나 쉬운 비밀번호가<br>아닌 새 비밀번호를 등록하고 주기적으로 변경<br>해주세요.</div>
            <div id="mypage_password_message">-비밀번호는 8~16 자의 영문 대소문자, 숫자를<br>조합하여 설정해주세요.</div>
            <button type="submit" id="mypage_password_membership">확인</button>
        </form>
    </div>
</div>
<!--푸터-->
