...
<div id="wraper">
    ...
    <div id="mypage_main">
        <p id="mypage_main_text">이웃</p>
    </div>

    <div id="mypage_following">
        <p id="mypage_following_text">Following</p>
    </div>
    <div id="mypage_follower">
        <p id="mypage_follower_text">Follower</p>
    </div>
    <div id="mypage_follow">
        <div id="mypage_following_list">
        </div>
        <div id="mypage_follower_list">
        </div>
    </div>
    <?php
    echo "<script>
        var userNo =".$_SESSION['user_no']." 
        getFollows(userNo);
    </script>";
    ?>
    <!--푸터-->
