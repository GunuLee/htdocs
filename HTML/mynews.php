...
<div id="wraper">
    ...
    <article class="boardArticle">
        <table>
            ...
            <tr>
                ...
                <th scope="col" class="date">발행일</th>
            ...
            <tr>
                <td class="no">2</td>
                <td class="title">
                    <a href="#none">홍길동님이 댓글을 달았습니다.</a></td>
                <td class="date">2016-09-16 21:00</td>
            </tr>
            <tr>
                <td class="no">1</td>
                <td class="title">
                    <a href="#none">홍길동님이 댓글을 달았습니다.</a></td>
                <td class="date">2016-09-16 20:00</td>
            </tr>
            <tr>
                <td class="no">2</td>
                <td class="title">
    ...
    <div id="notice_pagenumber">
        <button type="submit" id="pagenumber1">1</button>
        <button type="submit" id="pagenumber2">2</button>
        <button type="submit" id="pagenumber2">3</button>
    </div>
    <!--푸터-->
    <footer id="footer">
        <nav id="nav_footer">
