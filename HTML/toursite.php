...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/toursite.css">
...
<div id="header">
    ...
    <div id="menu">
        <ul>
            ...
            <a href="toursite.php" style="color: #f66d5b;"><li>관광지</li></a>
...
<div id="list">
    ...
    <div class="component_content" id="course_recommend">
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail1" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail2" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button2">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail3" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail4" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail5" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button2">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail6" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail7" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail8" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button2">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail9" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail10" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail11" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button2">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail12" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail13" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail14" class="toursite_button_img">
            </div>
        </a>
        <a href="" class="toursite_button2">
            <div class="toursite_button_child">
                <img id="tour_site_thumbnail15" class="toursite_button_img">
            </div>
        </a>
    </div>
</div>
...
<div class="pagenumber">
    ...
    <script>
        ...
        $("#number1").click(function () {
            ...
            thumbnailTourSite(flag * 0);
        });
        $("#number2").click(function () {
            var flag = $("#number2").val();
            thumbnailTourSite(flag * 15);
        });
