    ...
    <header id="main_header">
        ...
        <div id="search">
            <div id="search_text_field">
                    <span id="search_bar">
                            <input type='text' id='input_text' placeholder="관광지 검색" style="text-align: center"/>
                        </span>
    ...
    <nav id="nav_footer">
        ...
        <div class="adroidimg">
            <a href="https://play.google.com/store/apps/details?id=com.kocapplication.pixeleye.kockocapp"><img
                        src="../img/google.png" href="#none"></a>
        </div>
    </nav>
