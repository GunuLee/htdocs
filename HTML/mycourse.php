...
<div id="wraper">
    ...
    <!--content-->
    <div id="mypage">
        <li><a href="mykockoc.php" id="mypage_mypage1">MY PAGE</a></li>
        <br>
    ...
    <div id="mypage_main">
        <p id="mypage_main_text">내코스</p>
    </div>
    <div class="component_content" id="course_recommend">
    </div>
    <div id="pagenumber">
        <button type="submit" class="number" id="number1" onclick="number1()" value="0">1</button>
        ...
        <script>
            ...
            var userNo = <?php
                ...
                $(document).ready(function () {
                    mycourse_ajax(0, userNo);
                });

            $("#number1").click(function () {
                var flag = $("#number1").val();
                mycourse_ajax(flag * 0, userNo);
            });
            $("#number2").click(function () {
                var flag = $("#number2").val();
                mycourse_ajax(flag * 15, userNo);
            });
