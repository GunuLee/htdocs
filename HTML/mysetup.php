...
<div id="wraper">
    ...
    <div id="mypage_setup">
        <div id="mypage_setup_list">계정설정</div>
        <dir id="mypage_setup_password"><a href="mypassword.php">비밀번호 변경</a></dir>
        <dir id="mypage_setup_nickname"><a href="mynickname.php">닉네임 번경</a></dir>
        <dir id="mypage_setup_leave"><a id="leave" href="#" onclick="leave();">서비스 탈퇴</a></dir>
    </div>
</div>
<!--푸터-->
<footer id="footer">
